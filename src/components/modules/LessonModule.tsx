...
const FormModal: FC<FormModalProps> = ({ open, onClose, lessonsData }) => {
  ...
  if (!open || !lessonsData) return null;
  ...
  return (
    ...
    ">
      <div className={`${styles.form} w-[400px] z-50 relative`}>
        <p className={styles.title}>Edit Lesson</p>
        <p className={styles.message}>Edit the info of Lesson.</p>
