...
import FormModal from "@/components/modules/ExamModule";
...
const ExamsListPage=()=>{
    ...
    const [selectedParent, setSelectedParent] = useState<exam | null>(null);
  
    const handleEdit = (exam: exam) => {
      setSelectedParent(exam);
      setOpenModal(true);
    }
  ...
  const[add,setadd]=useState(false);
    ...
    <FormModal open={openModal} onClose={() => setOpenModal(false)} exam={selectedParent} />

        {/* top */}

        <div className="">
        <h1 className="text-white mb-3 ml-10 text-[25px]">All Exam</h1>
