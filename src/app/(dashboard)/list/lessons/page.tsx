...
import FormModal from "@/components/modules/LessonModule";
import {
  Table,
  TableBody,
  TableCell,
...
const LessonsListPage=()=>{
    ...
    const [selectedParent, setSelectedParent] = useState<lessonsData | null>(null);
  
    const handleEdit = (lessonsData: lessonsData) => {
      setSelectedParent(lessonsData);
      setOpenModal(true);
    }
  ...
  <FormModal open={openModal} onClose={() => setOpenModal(false)} lessonsData={selectedParent} />

        {/* top */}

        <div className="">
        <h1 className="text-white mb-3 ml-10 text-[25px]">All Lessons</h1>
            ...
            <TableRow key={item.id}>
              ...
              <TableCell>
                <div className="flex items-center gap-3">
                  <div>
                    <div className="font-medium ml-5">{item.subject}</div>
